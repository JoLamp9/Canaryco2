...
void setup() {
    ...
    while (digitalRead(RESETBUTT) == HIGH){ // inital location check, This removes concerns around power loss while bird is down. final product will include limit switch.
      OneStep(true);
      delay(2);
    }
